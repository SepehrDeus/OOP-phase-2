...
public class KickAdmin {

    private static final Stage stage = new Stage();
    static {
        stage.initModality(Modality.APPLICATION_MODAL);
        stage.setTitle("Kick admin");
        stage.setResizable(false);
        Image icon = new Image("icon.png");
        stage.getIcons().add(icon);
    }
    private static final FXMLLoader fxmlLoader = new FXMLLoader(ControllerContext.class.getResource("kick-admin.fxml"));
    ...
    public static KickAdmin getController() {
    ...
    public void kick_admin(ActionEvent event) throws SQLException {
